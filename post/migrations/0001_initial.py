...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img1', models.ImageField(blank=True, upload_to='logos/')),
                ('img2', models.ImageField(blank=True, upload_to='logos/')),
                ('img3', models.ImageField(blank=True, upload_to='logos/')),
                ('img4', models.ImageField(blank=True, upload_to='logos/')),
            ],
        ),
        migrations.CreateModel(
            name='SiteLogo',
